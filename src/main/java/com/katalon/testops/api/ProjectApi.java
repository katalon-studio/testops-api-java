...
@Component("com.katalon.testops.api.ProjectApi")
public class ProjectApi {
     ...
     */
    public ProjectResource create2(ProjectResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling create2");
        }
        String path = UriComponentsBuilder.fromPath("/api/v1/projects").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ProjectSettingResource createOrUpdate(ProjectSettingResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling createOrUpdate");
        }
        String path = UriComponentsBuilder.fromPath("/api/v1/project-settings").build().toUriString();
    ...
    public void createSampleData(Long id) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/projects/{id}/sample-data").buildAndExpand(uriVariables).toUriString();
    ...
    public ProjectResource delete2(Long id) throws RestClientException {
        ...
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/api/v1/projects/{id}").buildAndExpand(uriVariables).toUriString();
    ...
    public ProjectSettingResource get6(Long id) throws RestClientException {
        ...
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/api/v1/project-settings/{id}").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ProjectResource update2(ProjectResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
