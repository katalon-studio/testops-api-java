...
@Component("com.katalon.testops.api.TeamApi")
public class TeamApi {
     ...
     */
    public TeamResource create3(TeamResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling create3");
        }
        String path = UriComponentsBuilder.fromPath("/api/v1/teams").build().toUriString();
    ...
    public TeamResource delete4(Long id) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/teams/{id}").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TeamResource update4(TeamResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling update4");
        }
        String path = UriComponentsBuilder.fromPath("/api/v1/teams").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public UserTeamResource updateUserTeam(UserTeamResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling updateUserTeam");
        }
        String path = UriComponentsBuilder.fromPath("/api/v1/permission/team/user").build().toUriString();
