...
@Component("com.katalon.testops.api.WebServiceApi")
public class WebServiceApi {
    ...
    public TestObjectResource get16(String id) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/test-objects/{id}").buildAndExpand(uriVariables).toUriString();
