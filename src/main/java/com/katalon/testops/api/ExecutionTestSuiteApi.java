...
@Component("com.katalon.testops.api.ExecutionTestSuiteApi")
public class ExecutionTestSuiteApi {
    ...
    public ExecutionTestSuiteResource get3(String id) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/execution-test-suites/{id}").buildAndExpand(uriVariables).toUriString();
