...
@Component("com.katalon.testops.api.TestCaseApi")
public class TestCaseApi {
    ...
    public TestCaseResource get8(String id) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/test-cases/{id}").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TestCaseResource update5(TestCaseResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling update5");
        }
        String path = UriComponentsBuilder.fromPath("/api/v1/test-cases/update").build().toUriString();
