...
@Component("com.katalon.testops.api.ProjectConfigurationResourceControllerApi")
public class ProjectConfigurationResourceControllerApi {
    ...
    public ProjectConfigurationResource get14(Long id, String name) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/project-configurations/{id}").buildAndExpand(uriVariables).toUriString();
    ...
    public List<TimeZoneResource> listTimeZones() throws RestClientException {
        Object postBody = null;
        String path = UriComponentsBuilder.fromPath("/api/v1/time-zones").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ProjectConfigurationResource update8(ProjectConfigurationResource body, Long id) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling update8");
        }
        // verify the required parameter 'id' is set
        if (id == null) {
