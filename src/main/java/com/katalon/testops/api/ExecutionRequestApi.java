...
@Component("com.katalon.testops.api.ExecutionRequestApi")
public class ExecutionRequestApi {
    ...
    public void download(Long id, String fileType) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/requests/{id}/download").buildAndExpand(uriVariables).toUriString();
    ...
    public ExecutionRequestResource getExecutionRequest(Long id) throws RestClientException {
        ...
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/api/v1/requests/{id}").buildAndExpand(uriVariables).toUriString();
