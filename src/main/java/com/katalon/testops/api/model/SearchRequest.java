 ...
 */
@JsonPropertyOrder({
  SearchRequest.JSON_PROPERTY_SEARCH_REQUEST_CONDITIONS,
  SearchRequest.JSON_PROPERTY_SEARCH_REQUEST_PAGINATION,
  SearchRequest.JSON_PROPERTY_SEARCH_REQUEST_GROUP_BYS,
  SearchRequest.JSON_PROPERTY_SEARCH_REQUEST_FUNCTIONS,
  SearchRequest.JSON_PROPERTY_TYPE,
  SearchRequest.JSON_PROPERTY_SEARCH_ENTITY,
  SearchRequest.JSON_PROPERTY_TIME_ZONE
})
...
public class SearchRequest implements Serializable {
  ...
  public static final String JSON_PROPERTY_SEARCH_REQUEST_CONDITIONS = "searchRequestConditions";
  private List<SearchRequestCondition> searchRequestConditions = null;

  public static final String JSON_PROPERTY_SEARCH_REQUEST_PAGINATION = "searchRequestPagination";
  private SearchRequestPagination searchRequestPagination;

  public static final String JSON_PROPERTY_SEARCH_REQUEST_GROUP_BYS = "searchRequestGroupBys";
  private List<String> searchRequestGroupBys = null;

  public static final String JSON_PROPERTY_SEARCH_REQUEST_FUNCTIONS = "searchRequestFunctions";
  ...
  private SearchEntityEnum searchEntity;
  ...
  public SearchRequest addSearchRequestConditionsItem(SearchRequestCondition searchRequestConditionsItem) {
    if (this.searchRequestConditions == null) {
      this.searchRequestConditions = new ArrayList<>();
    }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SEARCH_REQUEST_CONDITIONS)
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_SEARCH_REQUEST_PAGINATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public SearchRequest addSearchRequestGroupBysItem(String searchRequestGroupBysItem) {
    if (this.searchRequestGroupBys == null) {
      this.searchRequestGroupBys = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_SEARCH_REQUEST_GROUP_BYS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public SearchRequest addSearchRequestFunctionsItem(SearchRequestFunction searchRequestFunctionsItem) {
    if (this.searchRequestFunctions == null) {
      this.searchRequestFunctions = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_SEARCH_REQUEST_FUNCTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
