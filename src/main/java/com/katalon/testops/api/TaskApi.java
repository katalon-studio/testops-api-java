...
@Component("com.katalon.testops.api.TaskApi")
public class TaskApi {
     ...
     */
    public IncidentResource createIncident(IncidentResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'body' when calling createIncident");
        }
        String path = UriComponentsBuilder.fromPath("/api/v1/incidents").build().toUriString();
    ...
    public IncidentResource get4(Long id) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/incidents/{id}").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public IncidentResource update1(IncidentResource body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
