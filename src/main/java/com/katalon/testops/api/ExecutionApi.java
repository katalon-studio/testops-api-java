...
public class ExecutionApi {
    ...
    public ExecutionResource reImportExecution(Long id) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/executions/reimport").build().toUriString();
    ...
    public ExecutionResource terminatedExecution(Long projectId, Long order) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/api/v1/executions/terminate").build().toUriString();
    ...
    public ExecutionResource unlinkRelease(Long id) throws RestClientException {
        ...
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/api/v1/executions/{id}/unlink-release").buildAndExpand(uriVariables).toUriString();
